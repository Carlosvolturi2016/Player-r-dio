...
const tracks = [
    // Adicione sua lista de faixas conforme necessário
        ...
        { src: 'musicas/Por Amor.mp3', cover: 'fotos/resgate.jpg', title : 'Por Amor'},
        { src: 'musicas/Jerusálem e Eu.mp3', cover: 'fotos/j.jpg', title : 'Jerusálem e Eu'},
        { src: 'musicas/_Antes que venha o Inverno_ Pr. Marco Feliciano G.M.U.H 2006.mp3', cover: 'fotos/inverno.jpg', title : 'Antes que venha o Inverno_ Pr. Marco Feliciano'},
        { src: 'musicas/PR ISAIAS DE OLIVEIRA  (VIVENDO O PROPOSITO).mp3', cover: 'fotos/proposito.jpg', title : 'VIVENDO O PROPOSITO'},
        { src: 'musicas/LUKAS AGUSTINHO I ADORAÇÃO PROFÉTICA.mp3', cover: 'fotos/lukas.jpg', title : ' ADORAÇÃO PROFÉTICA'},
        { src: 'musicas/Pr Suzano Selmo Pt. 02 - Louvor e Adoração - ( Ao vivo ).mp3', cover: 'fotos/suzano.jpg', title : 'Louvor e Adoração'},
        { src: 'musicas/05 Nos Braços do Pai _ Diante do Trono 5 Nos Braços do Pai _ Diante do Trono.mp3', cover: 'fotos/braços.jpg', title : 'Nos Braços do Pai'},
        ...
        { src: 'musicas/ANGELO GALVÃO -  ENTERRO CANCELADO (Mensagem Completa).mp3', cover: 'fotos/enterro.jpg', title : ' ENTERRO CANCELADO'},
        { src: 'musicas/Pr Suzano Selmo Pt. 01 Conferência ( Live ).mp3', cover: 'fotos/suzano.jpg', title : ' Conferência'},
        { src: 'musicas/Eu Navegarei (Reggae) - Raiz do Rei.mp3', cover: 'fotos/decreto.jpg', title : 'EU NAVEGAREI'},
        { src: 'musicas/Pr Suzano Selmo Pt. 01 Conferência ( Live ).mp3', cover: 'fotos/suzano.jpg', title : ' Conferência'},
